...
const rawData = [
  ...
  { date: "11/04", ttf: 43.63, belpex: 48.76, brent: 95.20, storage: 24.6, note: "Vandaag" }
].sort((a, b) => {
    ...
    <div style={{ background: "#0f172a", minHeight: "100vh", color: "#e2e8f0", fontFamily: "Georgia, serif", padding: "24px 20px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        <div style={{ color: "#0ea5e9", fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 8, fontFamily: "monospace" }}>
          MARKTANALYSE — 11 APRIL 2026 · 21:57 CET
        </div>
      ...
      <div style={{ background: "#7c131322", border: "1px solid #ef4444", borderRadius: 10, padding: "14px 20px", marginBottom: 24, display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 13, color: "#fca5a5" }}>
            Hormuz crisis dag 21+ · TTF €43.63 (-11.4% vs piek) · Brent $95.20 · Force majeure Qatar/Kuwait/UAE · Belgische gasreserves 25%
          </div>
        </div>
      </div>
      ...
      {tab === "context" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 }}>
          <div style={SECTION}>
            ...
            {[
              ["BE-gemiddelde (11 apr 2026)", "~25%",          "#ef4444"],
      ...
      {tab === "advies" && (<>
        ...
        <div style={{ ...SECTION, background: "#172554", border: "3px solid #3b82f6", borderRadius: 14, padding: "24px 28px" }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.85, color: "#bfdbfe", margin: "0 0 14px", fontWeight: 500 }}>
            TTF daalde vandaag naar €43.63/MWh (-12.1%), wat duidt op marktverlichting na de piek van €60.60. Echter, de structurele LNG-disruptie blijft van kracht (Rabobank: Q2 2026 TTF €61/MWh). Wie nu vastlegt op €53.25 betaalt waarschijnlijk méér dan het gemiddelde over de komende 12-18 maanden.
          </p>
...
Opgesteld: 11 april 2026 · 21:57 · Niet-officieel advies — raadpleeg VREG of een erkend energieadviseur voor definitieve beslissingen
        </div>
      </div>
